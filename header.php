...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Cabin+Sketch|Dancing+Script|David+Libre|Open+Sans+Condensed:300|Poiret+One" rel="stylesheet">
...
<?php wp_nav_menu( array( 'theme_location' => 'header-menu' ) ); ?>
    ...
    <div class="container">
      <div class="description">
        <h3>Project Name</h3>
        <!--<p>A community is commonly considered a social unit (a group of people) who share something in common...</p>-->
      </div>
